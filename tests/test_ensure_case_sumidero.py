...
@pytest.mark.parametrize("case_id", [
    ...
    # Via REDACTADA a proposito: el original llevaba una direccion real que esta en la
    # blocklist de PII. Lo que este positivo ejerce es la FORMA —ordinal, coma, punto,
    # guion y el W-code entre parentesis—, no la calle.
    "BaRR3 - Via Redactada 204, pr. 1ª - (W-02THLJ) - LAU 20",
