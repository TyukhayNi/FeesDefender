...
- [ ] **🚩 RIESGO tope de licencia (4 concurrentes):** confirmar si una sesión JWT del MCP consume licencia (Nikolai+3 compañeros=4, sin margen; entrar expulsó al usuario de soporte). Posible bloqueante del escalado simultáneo. Mitigaciones a estudiar: reusar token de sesión web, ampliar licencias, o limitar concurrencia.
