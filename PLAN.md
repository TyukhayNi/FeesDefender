...
| 38 | [Con qué modelo corre la revisión adversarial: política provisional y su calibración](#siguiente-modelo-revisor-con-qué-modelo-corre-la-revisión-adversarial) | **política ✅ ESCRITA (PR [#395](https://github.com/TyukhayNi/FeesDefender/pull/395)), con la R1 de Codex adjudicada —`REQUIERE-REVISION`, 10 de 11 confirmados y remediados— y la fila de la gobernanza corregida por Nikolai a Sol·alto; ✅ calibración 5 de 5; ✅ CONFIRMADA por Nikolai el 2026-09-26** con el ledger delante —`gpt-6-sol`·`high` habitual y las filas de Astra como estaban—: deja de decirse provisional en `CLAUDE.md` y en el contrato (rev. 12). Cerrar la calibración cumplió el disparador de `MEJORAS #280` y `#281`, promovidas a las filas #48 y #49 (ledger en su sección; la celda decía 0 hasta el 2026-09-26, con dos filas ya escritas) | encargo de Nikolai del 2026-09-23 sobre el informe de consumo de catorce días. **Disparador de cierre:** cinco encargos **ordinarios** corridos con `gpt-6-sol`·`high`, con su ficha en el ledger de abajo. Mientras no estén los cinco, la política es **provisional** y así se declara en `CLAUDE.md` | bajo |
...
**Confirmada por Nikolai el 2026-09-26**, con el ledger lleno delante: respondió «ok» a la
recomendación de confirmar `gpt-6-sol`·`high` como habitual y dejar las filas de Astra como
estaban. Lo que sigue es el registro de cómo se llegó, **con una salvedad**: `CLAUDE.md` preveía
que la calibración reutilizara objetos con defectos ya confirmados, y las cinco filas fueron
encargos vivos. Cerrar la calibración cumplió además el disparador de `MEJORAS #280` y `#281`,
promovidas a las filas #48 y #49.
...
**Ledger de calibración — 5 de 5: completo; Nikolai confirmó la política el 2026-09-26.** Una fila por encargo **ordinario**, que es la fila de **una**
