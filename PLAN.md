...
>    2026-09-10 en el worktree `caso-drive-juicio-8843b7` (rama `claude/verificar-pull-hash`),
>    con `core/intake_drive_hash.py` y sus tests. Rescatarlas es una fila nueva: **#29**.
