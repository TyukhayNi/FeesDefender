...
| 35 | **[APERTURA-VIABILIDAD]** La corrida prepara el JSON de viabilidad y una sesión lo remata en un paso, y el correo entra en la secuencia | pendiente — decisión de Nikolai el 2026-09-14, salida 3 de `MEJORAS #264` | Dos hallazgos medidos el 2026-09-15 mueven el alcance: el contrato del JSON que publica `MEJORAS #262` tiene **cuatro campos mal** (12.000 € se tiran en silencio y sale `OK`), y el **equipo comercial no es derivable** de `_ficha_crm.yaml` (10 fichas reales, 25 colaboradores, cero claves de rol). La corrida rellena **4 de los 11 campos**; el resto queda como residuo marcado. **No cierra `#264`:** la etapa `sala_lectura` sigue abierta. Spec: `docs/superpowers/specs/2026-09-15-corrida-prepara-sesion-remata-design.md` · Plan: `docs/superpowers/plans/2026-09-15-corrida-prepara-sesion-remata.md` | alto |
