...
|---|---|---|
| `handoff-2026-08-01-identidad-segmento-codex-review.md` | consumido | 1ª pasada adversarial de Codex sobre la rev. 1 de `2026-08-01-identidad-segmento-bundle-design.md` (NO SHIP, 2 B0 + 5 A + 3 M). Adjudicada en el §12 de la spec; **B0-2 cambió la decisión central** (del ordinal `seg` a un `doc_id` persistente). |
