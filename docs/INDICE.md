...
|---|---|---|
| `handoff-2026-09-10-consulta-apertura-menos-decisiones.md` | activo | Consulta del 2026-09-10 sobre la apertura automatizada, medida sobre las **siete** aperturas de ese día (99º-105º): V1 cubre ~15 % del reloj y era el tramo desatendido; el 85 % restante (clasificar, viabilidad, ficha, verificar, reparar) sigue en el operador. Inventario de las ~12 entradas humanas por apertura (4 jurídicas) y ocho propuestas P0-P8 (secuencia V2+V3 sobre `secuenciar`, `verificar_apertura`, capa base `#225`/`#214`/`#215`, sala sin parada, 88 filas de viabilidad, ficha sin YAML a mano, identidad sin teclado, una sesión por N aperturas), con orden y las tres decisiones de Nikolai. No reserva números de `MEJORAS` ni toca `PLAN.md`. |
