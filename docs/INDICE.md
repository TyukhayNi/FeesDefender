...
| `INSTALACION_ASR.md` | Instalación del reconocimiento de voz (`scripts/transcribir_audio.py`): receta del venv dedicado, modelos, y las cifras que eligen modelo y grada. Cableado a la sala de máquina pendiente (`MEJORAS #194`). |
