...
Cuando se cablee a la sala de máquina (`MEJORAS #182`), la dependencia entra como **extra
...
- **Cableado a la sala de máquina**: `MEJORAS #182`. Hoy la herramienta se llama a mano;
