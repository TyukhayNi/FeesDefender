...
FICHA = codicert.Ficha(token="t" * 64, vence=__import__("datetime").datetime.max.replace(
...
def main(argv: list[str] | None = None) -> int:
    ...
    plan = exp.planificar(args.w_code, args.tipo, [__import__("pathlib").Path(d) for d in args.docs],
