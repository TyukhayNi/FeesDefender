...
fecha: 2026-09-08
revision: 2
abre: MEJORAS #202, MEJORAS #203, MEJORAS #204
rondas_previstas: 1
...
«sí lo tiene y no se pudo leer» (`MEJORAS #201`). Mientras eso no se separe, la skill lee
...
- **`MEJORAS #202`** — `.claude/skills/verificacion-anclada-fuente/SKILL.md` tiene **359
  ...
  texto**.
- **`MEJORAS #203`** — `id_carpeta 304` (carpeta DEMANDA del expediente judicial) no está en
