...
| Ítem | Estado |
|------|--------|
| Tests | ✅ **6.483 recogidos · 0 fallos · 0 errores · 96 en `skipped`** — **medido el 2026-09-26** (137º cierre), con las **dos semillas** (777 y 31337), conteo idéntico en las dos, sobre `main` con el #398 y el #401 dentro. El delta de cada cierre, explicado test a test, va en su bloque de la bitácora; la cifra se mide en cada cierre: un número viejo aquí no es un dato, es ruido. |
