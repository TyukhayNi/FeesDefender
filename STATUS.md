...
| Ítem | Estado |
|------|--------|
| Tests | ✅ **5.470 recogidos · 0 fallos · 0 errores · 94 en `skipped`** (incluye los `xfail`) — **medido el 2026-09-13** (117º cierre), contado por **JUnit XML**. **+38 sobre el 116º y cuadra al test** (9 del guard de la UI, 26 del lector de estado, 3 de `test_verificar_apertura`). La cifra se mide en cada cierre: un número viejo aquí no es un dato, es ruido. |
