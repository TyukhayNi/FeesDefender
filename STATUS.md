...
| Ítem | Estado |
|------|--------|
| Tests | ✅ **5.148 recogidos · 0 fallos · 0 errores · 93 en `skipped`** (incluye los `xfail`) — **medido el 2026-09-10** (104º cierre) con **dos semillas**, 777 y 31337, y contado por **JUnit XML**. La cifra anterior de esta fila era del 92º cierre y llevaba **216 tests de desfase**: se mide en cada cierre, así que un número viejo aquí no es un dato, es ruido. |
