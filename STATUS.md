...
| Ítem | Estado |
|------|--------|
| Tests | ✅ **6.713 recogidos · 0 fallos · 0 errores · 96 en `skipped`** (incluye los `xfail`; por JUnit) — **medido el 2026-09-26** en la rama del PR #404 (`MEJORAS #303`), con las **dos semillas** (777 y 31337) por la verja de `session_close`: los 6.695 de `main` (`ca250a4`, con el #400 dentro) más los 18 del #303. El delta de cada cierre, explicado test a test, va en su bloque de la bitácora; la cifra se mide en cada cierre: un número viejo aquí no es un dato, es ruido. |
