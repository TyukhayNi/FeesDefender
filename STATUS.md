...
| Ítem | Estado |
|------|--------|
| Tests | ✅ **6.865 recogidos · 0 fallos · 0 errores · 96 en `skipped`** (incluye los `xfail`) — **medido el 2026-09-26** en la rama del PR #408 (la población de la sala de lectura, fila #46), sobre `main` (`1aa1871`) y con las **dos semillas** (777 y 31337) por la verja de `session_close`: los 6.813 de `main` más los 31 de la construcción y 21 netos del remedio de la R1. El delta de cada cierre, explicado test a test, va en su bloque de la bitácora; la cifra se mide en cada cierre: un número viejo aquí no es un dato, es ruido. |
