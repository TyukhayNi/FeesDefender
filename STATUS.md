...
| Ítem | Estado |
|------|--------|
| Tests | ✅ **6.439 recogidos · 0 fallos · 0 errores · 94 en `skipped`** (incluye los `xfail`; por JUnit) — **medido el 2026-09-26** (PR #400, `crm_ficha`): verde con las **dos semillas** (777 y 31337) por la verja de `session_close`, y otra corrida completa tras el último cambio de documentos. **+212 y cuadra al test** contra `4209582` (6.227, contados en una copia de ese commit, no tomados de un cierre anterior): 186 de la construcción de `crm_ficha` y 26 del remedio de su R3; ningún test retirado. La cifra se mide en cada cierre: un número viejo aquí no es un dato, es ruido. |
