...
| Ítem | Estado |
|------|--------|
| Tests | ✅ **3.292 passed · 77 skipped · 7 xfailed** (3.376 recogidos) · 0 fallos, 0 errores — **medido el 2026-08-25** (66º cierre) con **dos semillas**, 777 y 31337. Lo de las dos semillas no es celo: la suite corre con `pytest-randomly` y en el 65º la 31337 salió verde mientras la **777 sacaba ocho fallos** dentro del PR que iba a mergearse. **Una sola corrida verde no dice nada sobre orden.** El salto desde los 2.879 del 2026-08-24 son los Tasks 6-11 de la Fase 1 dual (PRs #231-#236), no una anomalía. Los **7 `xfail`** son los defectos del frontal de la biblioteca reproducidos a propósito en la Fase 0 de la arquitectura dual; se arreglan en su Fase 2 (`PLAN.md` fila #3) — eran 11 hasta que el Task 6 resolvió los cuatro de `test_constructores_localizador`. Histórico por sesión: bitácora de cierres. |
