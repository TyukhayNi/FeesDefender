...
| Ítem | Estado |
|------|--------|
| Tests | ✅ **2.795 passed · 77 skipped · 7 xfailed** (2.879 recogidos) · 0 fallos, 0 errores — **medido el 2026-08-24** con `session_close`. El `+4` frente al 2.875 anterior viene del merge de `main` en la rama del PR #225 (`tests/test_smoke_paso7.py`), no de trabajo nuevo. Los **7 `xfail`** son los defectos del frontal de la biblioteca reproducidos a propósito en la Fase 0 de la arquitectura dual; se arreglan en su Fase 2 (`PLAN.md` fila #3). Histórico por sesión: bitácora de cierres. |
